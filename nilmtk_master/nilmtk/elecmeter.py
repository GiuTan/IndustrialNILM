...
class ElecMeter(Hashable, Electric):
    ...
    def __init__(self, store=None, metadata=None, meter_id=None):
        ...
        self.store = store
        self.cache = nilmtk_master.nilmtk.STATS_CACHE
        self.identifier = meter_id

        # Insert self into nilmtk.global_meter_group
        if self.identifier is not None:
            assert isinstance(self.identifier, ElecMeterID)
            if self not in nilmtk_master.nilmtk.global_meter_group.meters:
                nilmtk_master.nilmtk.global_meter_group.meters.append(self)
    ...
    def upstream_meter(self, raise_warning=True):
        ...
        upstream_meter = nilmtk_master.nilmtk.global_meter_group[id_of_upstream]
