...
with warnings.catch_warnings():
    ...
    from nilmtk_master.nilmtk import *
    from nilmtk_master.nilmtk.version import version as __version__
    from nilmtk_master.nilmtk.timeframe import TimeFrame
    from nilmtk_master.nilmtk.elecmeter import ElecMeter
    from nilmtk_master.nilmtk.datastore import DataStore, HDFDataStore, CSVDataStore, TmpDataStore, Key
    from nilmtk_master.nilmtk.metergroup import MeterGroup
    from nilmtk_master.nilmtk.appliance import Appliance
    from nilmtk_master.nilmtk.building import Building
